...
public abstract partial class FFmpeg
{
    ...
    public async static Task<IMediaInfo> GetMediaInfo(string filePath)
    {
        return await MediaInfo.Get(filePath);
    }
    ...
    public async static Task<IMediaInfo> GetMediaInfo(string filePath, CancellationToken cancellationToken)
    {
...
public class Snippets
{
    ...
    /// <returns>IConversion object</returns>
    public async Task<IConversion> VisualiseAudio
    (
